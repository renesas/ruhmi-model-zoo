...
int8_t buf_serving_default_input_0[6912];
...
int8_t* GetModelOutputPtr_PartitionedCall_0_70154() {
  return (int8_t*) (sub_0000_arena + sub_0000_address_PartitionedCall_0_70154);
}


void RunModel(bool clean_outputs) {
  // Buffers for NPU units
  int8_t* buf_PartitionedCall_0_70154 = (int8_t*) (sub_0000_arena + sub_0000_address_PartitionedCall_0_70154);
