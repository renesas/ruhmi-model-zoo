...
/* ══════════════════════════════════════════════════════════════════════
 * 4.  MODEL FILE SIZES  (bytes on disk)
 * ══════════════════════════════════════════════════════════════════════ */
/**
 * TFLite Micro tensor arena size (bytes).
 * Measured value from TFLite Micro profiling on this model.
 */
#define CPU_RAM_TENSOR_ARENA_BYTES   2635217    /* ~ 2.52 MB  */
#define NPU_RAM_TENSOR_ARENA_BYTES   1505280    /* ~ 1.43 MB  */

/* ══════════════════════════════════════════════════════════════════════
 * 5.  MEMORY FOOTPRINT  (approximate, read from tflite flatbuffer)
 * ══════════════════════════════════════════════════════════════════════ */
