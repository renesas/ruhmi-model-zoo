...
def main():
    parser = argparse.ArgumentParser(
        description="Single-image TFLite inference for MobileNetV2 (FP32/INT8).",
        ...
        epilog=(
            ...
            "  python inference.py path/to/image.jpg --model model/mobilenet_v2_INT8.tflite\n"
        ),
    )
    parser.add_argument(
    ...
    if image_path is None:
        print("┌─────────────────────────────────────────────────────────┐")
        print("│              MobileNetV2 — TFLite Inference             │")
        print("├─────────────────────────────────────────────────────────┤")
