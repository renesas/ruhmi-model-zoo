...
__attribute__((aligned(16), section(".sdram"))) uint8_t sub_0032_arena[59584];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0032_fast_scratch[59584];
