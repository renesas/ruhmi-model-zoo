...
__attribute__((aligned(16), section(".sdram"))) uint8_t sub_0004_arena[94080];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0004_fast_scratch[94080];
...
int sub_0004_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0004_model with size 3056 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0004_model_data;
  base_addrs_size[0] = sub_0004_model_data_size;
  // Buffer sub_0004_arena with size 94080 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0004_arena+0);
  base_addrs_size[1] = 94080;

  // Buffer sub_0004_fast_scratch with size 94080 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0004_arena+0);
  base_addrs_size[2] = 94080;

  // Buffer input_tensor_0 with size 37632 and address: 56448
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0004_arena+56448);
  base_addrs_size[3] = 37632;

  // Buffer output_tensor_0 with size 37632 and address: 37632
  if (clean_outputs) {
    memset(sub_0004_arena + 37632, 0, 37632);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0004_arena+37632);
