...
__attribute__((aligned(16), section(".sdram"))) uint8_t sub_0012_arena[47040];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0012_fast_scratch[47040];
...
int sub_0012_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0012_model with size 8416 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0012_model_data;
  base_addrs_size[0] = sub_0012_model_data_size;
  // Buffer sub_0012_arena with size 47040 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0012_arena+0);
  base_addrs_size[1] = 47040;

  // Buffer sub_0012_fast_scratch with size 47040 and address: 0
  ...
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0012_arena+18816);
  base_addrs_size[3] = 18816;

  // Buffer output_tensor_0 with size 18816 and address: 18816
  if (clean_outputs) {
    memset(sub_0012_arena + 18816, 0, 18816);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0012_arena+18816);
