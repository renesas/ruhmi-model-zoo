...
def main():
    parser = argparse.ArgumentParser(
        description="Build MobileNetV1 (alpha=0.25) from Keras and convert to TFLite."
    )
    parser.add_argument(
        "--mode",
    ...
    if mode in ("FP32", "BOTH"):
        ...
        out_path = "model/mobilenet_v1_FP32.tflite"
    ...
    if mode in ("INT8", "BOTH"):
        ...
        out_path = "model/mobilenet_v1_INT8.tflite"
        with open(out_path, "wb") as f:
            f.write(tflite_bytes)
        print(f"Saved {out_path}")
