...
def preprocess(image_path: str,
    ...
    Steps (mirrors MobileNet's expected pre-processing):
      1. Open with Pillow and force RGB (handles grayscale / RGBA images too).
      2. Resize to (width, height) using BILINEAR resampling.
      3. Cast to float32.
      4. Normalize: pixel = pixel / 127.5 - 1.0  → range [-1.0, 1.0]
