...
int8_t buf_PartitionedCall_0_70092[1000];
...
int8_t* GetModelOutputPtr_PartitionedCall_0_70092() {
  return (int8_t*) (sub_0000_arena + sub_0000_address_PartitionedCall_0_70092);
}


void RunModel(bool clean_outputs) {
  // Buffers for NPU units
  int8_t* buf_PartitionedCall_0_70092 = (int8_t*) (sub_0000_arena + sub_0000_address_PartitionedCall_0_70092);
