...
__attribute__((aligned(16), section(".sdram_from_ospi0_cs1"))) uint8_t sub_0028_arena[13824];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0028_fast_scratch[13824];
...
int sub_0028_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0028_model with size 21936 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0028_model_data;
  base_addrs_size[0] = sub_0028_model_data_size;
  // Buffer sub_0028_arena with size 13824 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0028_arena+0);
  base_addrs_size[1] = 13824;

  // Buffer sub_0028_fast_scratch with size 13824 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0028_arena+0);
  base_addrs_size[2] = 13824;

  // Buffer input_tensor_0 with size 4608 and address: 0
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0028_arena+0);
  base_addrs_size[3] = 4608;

  // Buffer output_tensor_0 with size 4608 and address: 4608
  if (clean_outputs) {
    memset(sub_0028_arena + 4608, 0, 4608);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0028_arena+4608);
  base_addrs_size[4] = 4608;
