...
__attribute__((aligned(16))) uint8_t sub_0012_arena[129024];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0012_fast_scratch[129024];
...
int sub_0012_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0012_model with size 22768 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0012_model_data;
  base_addrs_size[0] = sub_0012_model_data_size;
  // Buffer sub_0012_arena with size 129024 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0012_arena+0);
  base_addrs_size[1] = 129024;

  // Buffer sub_0012_fast_scratch with size 129024 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0012_arena+0);
  base_addrs_size[2] = 129024;

  // Buffer input_tensor_0 with size 73728 and address: 36864
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0012_arena+36864);
  base_addrs_size[3] = 73728;

  // Buffer output_tensor_0 with size 36864 and address: 73728
  if (clean_outputs) {
    memset(sub_0012_arena + 73728, 0, 36864);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0012_arena+73728);
  base_addrs_size[4] = 36864;
