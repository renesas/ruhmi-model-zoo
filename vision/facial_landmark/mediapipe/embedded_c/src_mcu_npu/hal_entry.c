...
void hal_entry(void)
{
    ...
    // Comparing outputs
    {
        ...
        int misses = CompareOutput(model_conv2d_30_70211, GetModelOutputPtr_conv2d_30_70211(), model_conv2d_30_70211_COUNT, 0.1f);
        if (misses == 0) {
            SEGGER_RTT_WriteString(0, "MATCH\r\n");
        } else {
            SEGGER_RTT_printf(0, "FAILED: %d/%d misses\r\n", misses, model_conv2d_30_70211_COUNT);
        }
    }

    {
        SEGGER_RTT_printf(0, "Comparing output 1\r\n");
        int misses = CompareOutput(model_conv2d_20_70212, GetModelOutputPtr_conv2d_20_70212(), model_conv2d_20_70212_COUNT, 0.1f);
        if (misses == 0) {
            SEGGER_RTT_WriteString(0, "MATCH\r\n");
        } else {
            SEGGER_RTT_printf(0, "FAILED: %d/%d misses\r\n", misses, model_conv2d_20_70212_COUNT);
        }
    }
