...
__attribute__((aligned(16))) uint8_t sub_0032_arena[3744];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0032_fast_scratch[3744];
...
int sub_0032_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0032_model with size 26560 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0032_model_data;
  base_addrs_size[0] = sub_0032_model_data_size;
  // Buffer sub_0032_arena with size 3744 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0032_arena+0);
  base_addrs_size[1] = 3744;

  // Buffer sub_0032_fast_scratch with size 3744 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0032_arena+0);
  base_addrs_size[2] = 3744;

  // Buffer input_tensor_0 with size 1152 and address: 1440
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0032_arena+1440);
  base_addrs_size[3] = 1152;
  ...
  if (clean_outputs) {
    memset(sub_0032_arena + 1152, 0, 288);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0032_arena+1152);
  base_addrs_size[5] = 288;

  // Buffer output_tensor_1 with size 1152 and address: 1440
  if (clean_outputs) {
    memset(sub_0032_arena + 1440, 0, 1152);
  }
  base_addrs[6] = (uint64_t)(uintptr_t) (sub_0032_arena+1440);
