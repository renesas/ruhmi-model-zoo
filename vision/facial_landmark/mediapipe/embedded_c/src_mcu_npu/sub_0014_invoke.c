...
__attribute__((aligned(16))) uint8_t sub_0014_arena[110592];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0014_fast_scratch[110592];
...
int sub_0014_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0014_model with size 7296 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0014_model_data;
  base_addrs_size[0] = sub_0014_model_data_size;
  // Buffer sub_0014_arena with size 110592 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0014_arena+0);
  base_addrs_size[1] = 110592;

  // Buffer sub_0014_fast_scratch with size 110592 and address: 0
  ...
  if (clean_outputs) {
    memset(sub_0014_arena + 36864, 0, 36864);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0014_arena+36864);
