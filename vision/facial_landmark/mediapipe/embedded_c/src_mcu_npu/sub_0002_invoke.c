...
__attribute__((aligned(16), section(".sdram_from_ospi0_cs1"))) uint8_t sub_0002_arena[442368];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0002_fast_scratch[442368];
...
int sub_0002_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0002_model with size 1152 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0002_model_data;
  base_addrs_size[0] = sub_0002_model_data_size;
  // Buffer sub_0002_arena with size 442368 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0002_arena+0);
  base_addrs_size[1] = 442368;

  // Buffer sub_0002_fast_scratch with size 442368 and address: 0
  ...
  if (clean_outputs) {
    memset(sub_0002_arena + 147456, 0, 147456);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0002_arena+147456);
