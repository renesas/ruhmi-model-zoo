...
__attribute__((aligned(16), section(".sdram_from_ospi0_cs1"))) uint8_t sub_0000_arena[258048];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0000_fast_scratch[258048];
...
int sub_0000_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0000_model with size 880 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0000_model_data;
  base_addrs_size[0] = sub_0000_model_data_size;
  // Buffer sub_0000_arena with size 258048 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[1] = 258048;

  // Buffer sub_0000_fast_scratch with size 258048 and address: 0
  ...
  // Buffer output_tensor_0 with size 147456 and address: 110592
  if (clean_outputs) {
    memset(sub_0000_arena + 110592, 0, 147456);
  }
