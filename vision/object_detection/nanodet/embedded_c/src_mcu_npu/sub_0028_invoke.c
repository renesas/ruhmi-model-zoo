...
__attribute__((aligned(16), section(".sdram"))) uint8_t sub_0028_arena[94400];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0028_fast_scratch[94400];
...
int sub_0028_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0028_model with size 122544 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0028_model_data;
  base_addrs_size[0] = sub_0028_model_data_size;
  // Buffer sub_0028_arena with size 94400 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0028_arena+0);
  base_addrs_size[1] = 94400;

  // Buffer sub_0028_fast_scratch with size 94400 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0028_arena+0);
  base_addrs_size[2] = 94400;

  // Buffer input_tensor_0 with size 23200 and address: 0
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0028_arena+0);
  base_addrs_size[3] = 23200;

  // Buffer input_tensor_1 with size 23200 and address: 46400
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0028_arena+46400);
  base_addrs_size[4] = 23200;

  // Buffer output_tensor_0 with size 46400 and address: 46400
  if (clean_outputs) {
    memset(sub_0028_arena + 46400, 0, 46400);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0028_arena+46400);
  base_addrs_size[5] = 46400;
