...
__attribute__((aligned(16), section(".sdram"))) uint8_t sub_0004_arena[390400];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0004_fast_scratch[390400];
...
int sub_0004_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0004_model with size 11712 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0004_model_data;
  base_addrs_size[0] = sub_0004_model_data_size;
  // Buffer sub_0004_arena with size 390400 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0004_arena+0);
  base_addrs_size[1] = 390400;

  // Buffer sub_0004_fast_scratch with size 390400 and address: 0
  ...
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0004_arena+185600);
  base_addrs_size[4] = 92800;

  // Buffer output_tensor_0 with size 185600 and address: 185600
  if (clean_outputs) {
    memset(sub_0004_arena + 185600, 0, 185600);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0004_arena+185600);
