...
__attribute__((aligned(16), section(".sdram"))) uint8_t sub_0000_arena[1157248];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0000_fast_scratch[1157248];
...
int sub_0000_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0000_model with size 22112 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0000_model_data;
  base_addrs_size[0] = sub_0000_model_data_size;
  // Buffer sub_0000_arena with size 1157248 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[1] = 1157248;

  // Buffer sub_0000_fast_scratch with size 1157248 and address: 0
  base_addrs[2] = (uint64_t)(uintptr_t) (sub_0000_arena+0);
  base_addrs_size[2] = 1157248;

  // Buffer input_tensor_0 with size 307200 and address: 839808
  base_addrs[3] = (uint64_t)(uintptr_t) (sub_0000_arena+839808);
  base_addrs_size[3] = 307200;

  // Buffer output_tensor_0 with size 185600 and address: 185600
  if (clean_outputs) {
    memset(sub_0000_arena + 185600, 0, 185600);
  }
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0000_arena+185600);
  base_addrs_size[4] = 185600;
