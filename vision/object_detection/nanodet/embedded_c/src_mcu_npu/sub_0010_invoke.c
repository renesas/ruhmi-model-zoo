...
__attribute__((aligned(16), section(".sdram"))) uint8_t sub_0010_arena[195200];
// Fast scratch arena not used for Ethos-U55
//  We will not create it for now and reuse the address of the other arena
// __attribute__((aligned(16))) static uint8_t sub_0010_fast_scratch[195200];
...
int sub_0010_invoke(bool clean_outputs) {
  ...
  // Buffer sub_0010_model with size 34736 and address: 4294967295
  base_addrs[0] = (uint64_t)(uintptr_t)sub_0010_model_data;
  base_addrs_size[0] = sub_0010_model_data_size;
  // Buffer sub_0010_arena with size 195200 and address: 0
  base_addrs[1] = (uint64_t)(uintptr_t) (sub_0010_arena+0);
  base_addrs_size[1] = 195200;

  // Buffer sub_0010_fast_scratch with size 195200 and address: 0
  ...
  base_addrs[4] = (uint64_t)(uintptr_t) (sub_0010_arena+92800);
  base_addrs_size[4] = 46400;

  // Buffer output_tensor_0 with size 92800 and address: 92800
  if (clean_outputs) {
    memset(sub_0010_arena + 92800, 0, 92800);
  }
  base_addrs[5] = (uint64_t)(uintptr_t) (sub_0010_arena+92800);
